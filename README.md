...
El sistema consistirá en una pagina que le permitirá a un usuario iniciar sesión, en caso de no tener una cuenta podra crearse una; elegir entre varias opciones de habitaciones para reservar y proceder a realizar un pago de forma segura. Utilizará Mysql como base de datos en un servidor local y php para conectarse a esta.

Requerimientos funcionales: 
- Se debe poder iniciar sesión o crear una cuenta en caso de que el cliente no tenga una
...
- La pagina debe adaptarse a distintos dispositivos
...
<img width="762" height="427" alt="MERSistemaReservaHotel drawio (1)" src="https://github.com/user-attachments/assets/3e44f374-d905-4a49-883e-c15e48557304" />

Modelo relacional:
<img width="739" height="411" alt="MRSistemaReservacionHotel drawio (1)" src="https://github.com/user-attachments/assets/464e7bfa-2c95-4995-a5f5-79bcaac20959" />

Diagrama de casos de uso + logica que manejara el sistema:
<img width="762" height="1061" alt="DCasosDeUso drawio (1)" src="https://github.com/user-attachments/assets/4ecade43-2110-44f6-a88b-2f7d8ded27d1" />
